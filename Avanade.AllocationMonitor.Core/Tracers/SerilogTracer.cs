using Avanade.AllocationMonitor.Core.Tracers.Common;
using Serilog;
...
namespace Avanade.AllocationMonitor.Core.Tracers
{
    /// <summary>
    /// Tracer for Log4Net
    /// </summary>
    public sealed class SerilogTracer : ITracer
    {
            ...
            if (_Log == null)
            {
                ...
                _Log = new LoggerConfiguration()
                    ...
                    .WriteTo.File(
                        ...
                        //Frequenza del rolling a 1 giorno
                        rollingInterval: RollingInterval.Day,

                        //Livello di log
                        restrictedToMinimumLevel: LogEventLevel.Verbose,

                        //Numero massimo di files conservati: 100
                        retainedFileCountLimit: 100,

                        //Dimensione massima file, 1GB
